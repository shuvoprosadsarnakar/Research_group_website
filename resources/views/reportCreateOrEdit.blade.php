    ...
    <div class="row">
            ...
            <div class="well">
                ...
                <table class="table-edit" >
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="{{route('report_edit',$reference->id)}}" class="btn btn-primary btn-mini"><i class="icon-edit icon-white"></i>E</a>
                        <a onclick="return confirm('Are you sure you want to delete this item?');" href="{{route('report_edit',$reference->id)}}" class="btn btn-danger btn-mini"><i class="icon-remove icon-white"></i>X</a>
                        </td>
                    </tr>
                    @endforeach
                </table>
        ...
        <div class="col-md-4">
            ...
            @if(isset($rEditInfo)) 
                ...
                <form action="@if(isset($rEditInfo)) {{ route ('report_edit_update',['id'=>$rEditInfo->id]) }} @else {{ route ('report_store') }}@endif" method="post" enctype="multipart/form-data">
                    
                    {{csrf_field()}}
                    <div class="form-group">
                        <label for="referencetitle">Report title:</label>
